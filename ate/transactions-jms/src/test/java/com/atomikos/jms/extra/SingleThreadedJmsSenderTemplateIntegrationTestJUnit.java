...
public class SingleThreadedJmsSenderTemplateIntegrationTestJUnit extends TransactionServiceTestCase 
{
	...
	public SingleThreadedJmsSenderTemplateIntegrationTestJUnit(String name) {
		super(name);
	}
	...
	protected void setUp() 
	{
        ...
        properties.setProperty ( 
				AbstractUserTransactionServiceFactory.TM_UNIQUE_NAME_PROPERTY_NAME , "SingleThreadedJmsTemplateTestJUnit" );
...
//	}
	...
	throws Exception
	{
		...
		template.sendTextMessage ( text );
   		...
   		assertTrue (  "Normal send refreshes connnection?" , TestQueueConnectionFactory.getNumberOfConnectionsCreated() == connections );
