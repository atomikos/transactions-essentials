...
public class TestStateRecoverable implements StateRecoverable, StateMutable,
			        FSMPreEnterListener
{
    ...
    protected Hashtable listeners_ ;
    ...
    public TestStateRecoverable ( Object id , Object state )
    {
        id_ = id;
        listeners_ = new Hashtable();
        fsm_ = new FSMImp ( new TestTransitionTable (), 
		        state );
    }
    
    /**
     * Sets the instance to return null
     * for getObjectImage calls.
     * Needed for testing issue 10041
     *
     */
    ...
    {
        Object[] ret = { TestTransitionTable.MIDDLE , TestTransitionTable.END };
        return ret;
    }
    ...
    {
        Object[] ret = { TestTransitionTable.END };
        return ret;
    }
    ...
    {
    		if ( returnNullObjectImage_ ) return null;
    		else return new TestStateRecoverableObjectImage (  state , id_ );
    }
				 ...
				 Object state )
    {
        ...
        Vector listeners = ( Vector ) listeners_.get ( state );
        if ( listeners == null ) 
    ...
    public void preEnter ( FSMEnterEvent e ) throws IllegalStateException
    {
        ...
        FSMEnterEvent event = new FSMEnterEvent ( this , state );
        
        Vector listeners = ( Vector ) listeners_.get ( state );
        if ( listeners == null ) 
	  return;

        Enumeration enumm = listeners.elements();
        while ( enumm.hasMoreElements() ) {
	  FSMPreEnterListener l = ( FSMPreEnterListener ) enumm.nextElement();
	  l.preEnter ( event );
        }
    }
    ...
    public void setState ( Object state ) throws IllegalStateException
    {
        fsm_.setState ( state );
    }
