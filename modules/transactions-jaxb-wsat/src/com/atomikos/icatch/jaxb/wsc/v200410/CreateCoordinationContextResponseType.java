...
@XmlType(name = "CreateCoordinationContextResponseType", namespace = "http://schemas.xmlsoap.org/ws/2004/10/wscoor", propOrder = {
    "coordinationContext",
    "any"
})
public class CreateCoordinationContextResponseType {

    @XmlElement(name = "CoordinationContext", namespace = "http://schemas.xmlsoap.org/ws/2004/10/wscoor", required = true)
