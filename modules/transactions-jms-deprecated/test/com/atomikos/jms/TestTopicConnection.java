...
implements XATopicConnection, TopicConnection
{
    
    private XAResource xares_;
    
    TestTopicConnection ( XAResource xares )
    {
        xares_ = xares; 
    }
        ...
        throws JMSException
    {
        ...
        return new TestTopicSession ( xares_ );
    }
    ...
    public ConnectionConsumer createConnectionConsumer (
        Topic queue , String selector , ServerSessionPool pool , int max )
    throws JMSException
    {
