...
public class PendingTransactionRecordTestJUnit {
	...
	public void testToRecord() throws Exception {
		...
		long expires = 100l;
		PendingTransactionRecord given = new PendingTransactionRecord(id, state, expires);
		//when
		String record = given.toRecord();
		//then
		assertEquals("id1|COMMITTING|100|"+System.getProperty("line.separator"), record);
	}
	@Test
	public void testFromRecord() throws Exception {
		String givenRecord = "id1|COMMITTING|100|123";
