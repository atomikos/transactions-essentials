...
import com.atomikos.icatch.event.transaction.TransactionAbortingEvent;
import com.atomikos.icatch.event.transaction.TransactionCommittingEvent;
...
public class TransactionEventTestJUnit {
	...
	public void testTransactionCommittedEvent() throws Exception {
		...
		Mockito.verify(eventListenerMock, Mockito.times(1)).eventOccurred(Mockito.any(TransactionCommittingEvent.class));
	}
	...
	public void testTransactionAbortedEvent() throws Exception {
		...
		Mockito.verify(eventListenerMock, Mockito.times(1)).eventOccurred(Mockito.any(TransactionAbortingEvent.class));
	}
