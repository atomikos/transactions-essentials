...
public class AssemblerImp implements Assembler {
	...
	private void checkRegistration(ConfigProperties configProperties) {
		if (configProperties.getCompletedProperties().getProperty("com.atomikos.icatch.registered") == null) {
			String message ="Thanks for using Atomikos! This installation is not registered yet. Register for FREE at http://www.atomikos.com/Main/RegisterYourDownload and receive tips & advice to get the most out of using Atomikos...";
