...
class ActiveStateHandler extends CoordinatorStateHandler
{
    ...
    private boolean discardCoordinatorAfterPrepare(boolean allReadOnly) { //cf case 197506
		return allReadOnly; //supported by default - can be tuned in commercial code base
	}
