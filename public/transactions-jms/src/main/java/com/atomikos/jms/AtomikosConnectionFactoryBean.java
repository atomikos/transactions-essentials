...
Referenceable, Serializable {
	...
	private com.atomikos.datasource.pool.ConnectionFactory<Connection> doInit() throws Exception 
	{
		...
		com.atomikos.datasource.pool.ConnectionFactory<Connection> cf = new com.atomikos.jms.AtomikosJmsXAConnectionFactory(xaConnectionFactory, tr, this);
	 ...
	 * and returned. 0 means no timeout. Optional, defaults to maxLifetime. 
	 * 
	 * @param timeout
	 */
	...
	{
		LOGGER.logDebug ( this + ": createConnection ( user , password ) ignores authentication - returning default connection" );
