...
public class AtomikosJmsConnectionProxy extends DynamicProxySupport<XAConnection>
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        try {
            ...
            String msg = "Error delegating '" + method.getName() + "' call to JMS driver";
            erroneous = true;
        ...
        if (createXaSession(transacted)) {
            ...
            if (session == null) {
                ...
                try {
                    ...
                    JmsProxyHelper.convertProxyError(vendorError, msg);
                }
            ...
            try {
                wrapped = delegate.createSession(transacted, acknowledgeMode);
            } catch (JMSException vendorError) {
