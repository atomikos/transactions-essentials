...
class AtomikosPooledJmsConnection extends AbstractXPooledConnection<Connection> implements SessionHandleStateChangeListener {
	...
	protected Connection doCreateConnectionProxy() throws CreateConnectionException {
		currentProxy = (Connection)AtomikosJmsConnectionProxy.newInstance (ignoreSessionTransactedFlag, xaConnection , jmsTransactionalResource , this , props );
		return currentProxy;
	}
