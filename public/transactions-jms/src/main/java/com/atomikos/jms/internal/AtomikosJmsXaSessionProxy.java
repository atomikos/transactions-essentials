...
public class AtomikosJmsXaSessionProxy extends AbstractJmsSessionProxy implements SessionHandleStateChangeListener {
    ...
    public MessageConsumer createDurableConsumer(Topic topic, String name)
    		throws JMSException {
    	 MessageConsumer vendorConsumer = delegate.createDurableConsumer(topic, name);
         return new AtomikosJmsMessageConsumerWrapper(vendorConsumer, state);
    ...
    public MessageConsumer createDurableConsumer(Topic topic, String name, String messageSelector, boolean noLocal) 
    		throws JMSException
    {
    	 MessageConsumer vendorConsumer = delegate.createDurableConsumer(topic, name, messageSelector, noLocal);
         return new AtomikosJmsMessageConsumerWrapper(vendorConsumer, state);
    }
    ...
    public MessageConsumer createSharedConsumer(Topic topic, String sharedSubscriptionName) 
    		throws JMSException {
    	MessageConsumer vendorConsumer = delegate.createSharedConsumer(topic, sharedSubscriptionName);
        return new AtomikosJmsMessageConsumerWrapper(vendorConsumer, state); 
    }

    @Proxied
    public MessageConsumer createSharedConsumer(Topic topic, String sharedSubscriptionName, java.lang.String messageSelector) 
    		throws JMSException {
    	MessageConsumer vendorConsumer = delegate.createSharedConsumer(topic, sharedSubscriptionName, messageSelector);
        return new AtomikosJmsMessageConsumerWrapper(vendorConsumer, state); 
    }
    ...
    public MessageConsumer createSharedDurableConsumer(Topic topic, String name) 
    		throws JMSException {
    	MessageConsumer vendorConsumer = delegate.createSharedDurableConsumer(topic, name);
        return new AtomikosJmsMessageConsumerWrapper(vendorConsumer, state); 
    }
    ...
    public MessageConsumer createSharedDurableConsumer(Topic topic, String name, String messageSelector) 
    		throws JMSException {
    	MessageConsumer vendorConsumer = delegate.createSharedDurableConsumer(topic, name, messageSelector);
        return new AtomikosJmsMessageConsumerWrapper(vendorConsumer, state); 
    }
