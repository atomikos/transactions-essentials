...
implements XAResource, Cloneable
{
   ...
   public static final int FAIL_MIN = FAIL_COMMIT;
    ...
    public void reset()
    {
    	if ( Configuration.isDebugLoggingEnabled() ) LOGGER.logDebug ( "XAResource.reset called on " + this );
    ...
    throws XAException
    {
    		if ( Configuration.isDebugLoggingEnabled() ) LOGGER.logDebug ( "XAResource.start called on " + this );
        lastStartedXid_ = xid;
    ...
    throws XAException
    {
    	    if ( Configuration.isDebugLoggingEnabled() ) LOGGER.logDebug ( "XAResource.end called on " + this );
        lastEndedXid_ = xid;
    ...
    throws XAException
    {
    	    if ( Configuration.isDebugLoggingEnabled() ) LOGGER.logDebug ( "XAResource.prepare called on " + this );
    ...
    throws XAException
    {
    		if ( Configuration.isDebugLoggingEnabled() ) LOGGER.logDebug ( "XAResource.rollback called on " + this );
    ...
    throws XAException
    {
    		if ( Configuration.isDebugLoggingEnabled() ) LOGGER.logDebug ( "XAResource.commit called on " + this );
