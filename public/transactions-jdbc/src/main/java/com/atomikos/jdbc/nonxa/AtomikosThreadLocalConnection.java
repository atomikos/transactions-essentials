...
implements JtaAwareNonXaConnection
{
	...
	static Connection newInstance ( AtomikosNonXAPooledConnection pooledConnection , String resourceName )
	{
		Connection ret = null;
		...
		ret = ClassLoadingHelper.newProxyInstance ( classLoaders , java.sql.Connection.class , interfaceClasses , new AtomikosThreadLocalConnection ( pooledConnection ) );
		
		AtomikosThreadLocalConnection c = (AtomikosThreadLocalConnection) Proxy.getInvocationHandler(ret);
	...
	public void registerXPooledConnectionEventListener ( XPooledConnectionEventListener<java.sql.Connection> l )
	{
