...
class AtomikosConnectionProxy extends AbstractConnectionProxy
{
	...
	public static Connection newInstance ( Connection c , SessionHandleState sessionHandleState )
	{
		...
		ret =  ClassLoadingHelper.newProxyInstance ( classLoaders , java.sql.Connection.class , interfaceClasses , proxy );
