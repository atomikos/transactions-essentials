...
public class RemotingTransactionServicePlugin implements TransactionServicePlugin {
	...
	private static final String REST_URL_PROPERTY_NAME = "com.atomikos.icatch.rest_port_url";
	...
	public void afterInit() {
	    AtomikosRestPort.init();
        DefaultImportingTransactionManager.setAtomikosRestPortUrl(findRestPortUrl());
	...
	private String findRestPortUrl() {
	    String ret = null;
	    try {
	        ret = configProperties.getProperty(REST_URL_PROPERTY_NAME);
