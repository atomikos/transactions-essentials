...
public class DefaultXaRecoveryLogTestJUnit {
	...
	public void setUp() throws Exception {
		...
		sut = new DefaultXaRecoveryLog(mock, 1000);
	...
	public void testPresumedAborting() throws IllegalStateException, LogException {
		...
		thenPresumedAbortingWithExpirationInFuture(xid);
	}
	...
	private void thenPresumedAbortingWithExpirationInFuture(Xid xid) throws IllegalStateException, LogException {
		...
		Assert.assertTrue(captor.getValue().expires > System.currentTimeMillis());
	}
