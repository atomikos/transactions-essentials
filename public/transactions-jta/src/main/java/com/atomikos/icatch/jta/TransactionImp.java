...
class TransactionImp implements Transaction {
	...
	private List<javax.transaction.Synchronization> interposedSynchronizations;
	...
	TransactionImp(CompositeTransaction ct) {
		...
		this.interposedSynchronizations = new ArrayList<>();
	...
	public void registerInterposedSynchronization(javax.transaction.Synchronization s)
			throws java.lang.IllegalStateException,
			javax.transaction.SystemException {
	...
	private void registerInterposedSynchronizations() throws IllegalStateException, SystemException {
		for (javax.transaction.Synchronization s : interposedSynchronizations) {
			registerSynchronization(s);
		}
	}

	public void putResource(Object key, Object value) {
		transactionSynchronizationRegistryMap.put(key, value);
	}

	public Object getResource(Object key) {
		return transactionSynchronizationRegistryMap.get(key);
	}
}
