  ...
  Externalizable, Referenceable
{
  ...
  private static final String NO_XACTION_FOR_THREAD = "No transaction for thread";
  ...
  private transient Map<Thread, String> threadToTidMap;
  ...
  {
    this.threadToTidMap = new HashMap<>();
   ...
   *
   * @param userTransactionServerLookupName userTransactionServerLookupName
   * @param configProperties configProperties
   */
  public RemoteClientUserTransaction(String userTransactionServerLookupName, ConfigProperties configProperties)
  {
    this(userTransactionServerLookupName, configProperties.getProperty("java.naming.factory.initial"),
      configProperties.getProperty("java.naming.provider.url"));
  }
  ...
  private String getNotFoundMessage()
  {
    String errorMsg = String.format(
      "Name not found: %s\nPlease check that: \n\t-server property com.atomikos.icatch.client_demarcation is set to true \n   -server property com" +
        ".atomikos.icatch.rmi_export_class is correct \n\t-server property java.naming.factory.initial is %s\n\t-server property java.naming.provider.url" +
        " is %s\n\t-the naming service is running on port %s\n\t-the transaction server is running",
      this.userTransactionServerLookupName, this.initialContextFactory, this.providerUrl, this.providerUrl);
  ...
  private boolean checkSetup()
  {
    ...
    if (this.txmgr == null)
    {
      ...
      try
      {
        ...
        Context ctx = new InitialContext(new Hashtable<>(env));
    ...
    java.lang.SecurityException
  {
    ...
    else
    {
      ...
      if (tid == null)
        throw new IllegalStateException(NO_XACTION_FOR_THREAD);
  ...
  public Reference getReference() throws NamingException
  {
    ...
    RefAddr timeoutRef = new StringRefAddr("Timeout", Integer.toString(this.timeout));
    ...
    ClassNotFoundException
  {
    ...
    if (tid != null)
    { // null if this instance was passed along outside a transaction
      setThreadMapping(tid);
      this.imported = true;
    }
